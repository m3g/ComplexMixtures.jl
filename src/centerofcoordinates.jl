...
function centerofcoordinates!(cm :: AbstractVector{Float64}, ifirst, ilast, coor :: AbstractArray{Float64})
  @. cm = 0.
...
function centerofcoordinates!(cm :: AbstractVector{Float64}, coor :: AbstractArray{Float64}) 
