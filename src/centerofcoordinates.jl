...
function centerofcoordinates!(cm :: AbstractVector{Float64}, ifirst, ilast, coor :: Array{Float64})
  @. cm = 0.
...
function centerofcoordinates!(cm :: AbstractVector{Float64}, coor :: Array{Float64}) 
